  ...
  return (
    <div style={styles.sidebar}>
      <ul style={styles.sidebarList}>
        ...
        <li><Link to="/admin/patients" style={styles.sidebarItem}>Patients</Link></li>

        <li><Link to="/doctor/appointments" style={styles.sidebarItem}>Appointments</Link></li>
        <li><Link to="/doctor/patients" style={styles.sidebarItem}>Patients</Link></li>

        <li><Link to="/patient/doctors" style={styles.sidebarItem}>Doctors</Link></li>
        <li><Link to="/patient/appointments" style={styles.sidebarItem}>Appointments</Link></li>
        <li><Link to="/patient/appointments/store" style={styles.sidebarItem}>Create Appointment</Link></li>
      </ul>
    </div>
  );
}
